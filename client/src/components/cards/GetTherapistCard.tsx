  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300">
      <div className="flex items-center mb-4">
        ...
        <h2 className="text-2xl font-bold ml-2 text-gray-900">Get a Doctor</h2>
      </div>
      ...
      <Button
      href="/livechat"
      variant="contained" color="primary" className=" bg-gradient-to-r from-green-400 via-green-500 to-green-600 mt-4 w-full">
        Find a Doctor
      </Button>
    </div>
  );
