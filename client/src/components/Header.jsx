...
import { deleteUserFailure, unSetProfile, deleteUserSuccess, setAndUnSetProfile, signOutUserStart } from "../features/user/userSlice";
const Header = () => {
  ...
  return (
    <header >
      <div className="flex justify-between items-center max-w-6xl mx-auto p-3">
        <div onClick={handleUnsetProfile} className="flex justify-between items-center max-w-6xl mx-auto p-3">
          <Link to="/">
          <div className="flex justify-center items-center">
            <img src={logo} width={80} alt="coclinic logo" />
              <h1 className="font-bold text-sm sm:text-xl flex flex-wrap">
                <span className="text-green-300">Co</span>
                <span className="text-green-700">Clinic</span>
              </h1>
          </div>
          </Link>
